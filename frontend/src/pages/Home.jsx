      ...
      <section className="story-section">
        <div className="container story-inner">
          <div className="story-text">
            ...
            <p>
                          أدهم رجع من إيطاليا وهو مش نفس الشخص — عشر أيام كمتطوع بريف توسكانا حسّسته إنو في سفر تاني بالكل...
                          مش بس سياحة, تجربه بسيطه مبنيه على البساطة , تروح وأنت مش متأكد وين رايح وشو رح يصير، بس مستعد تعيش التجربة العفوية بمرونتها.
                          بس الحياة ما بتوقف، والأيام بلشت تمشي، وشوي شوي بدأ يتناسى الموضوع...
                      </p>
            <p>
