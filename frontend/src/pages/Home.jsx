        ...
        <div className="container story-inner">
          <div className="story-text">
            ...
            <h2>مكالمة غيّرت كل شيء</h2>
                      <p>ادهم رجع من إيطاليا وهو مش نفس الشخص, عشر أيام كمتطوع بريف توسكانا فرجته إنو في سفر من نوع ثاني تماما، مش بس سياحة. تجربة عفوية مبنية على البساطة , تروح ومش متأكد وين رايح وشو رح يصير، بس مستعد تعيش تجربه عفويه ومرنه.</p>
                      <p>ومع إنه الحياة مشت وبدا يتناسى الموضوع، رن التلفون.. ذياب على الخط بيسأل عن الرحلة وحابب يجرب شيئ مشابه... ومن هذيك المحادثة العفوية ... وُلدت رُحى.</p>
