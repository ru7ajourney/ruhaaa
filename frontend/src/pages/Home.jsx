      ...
      <section className="story-section">
        <div className="container story-inner">
          <div className="story-text">
            ...
            <p>
أدهم رجع من إيطاليا وهو مش نفس الشخص — عشر أيام كمتطوع بريف توسكانا حسّسته إنو في سفر تاني بالكل، مش بس سياحة؛ سفر حقيقي مبني على البساطة تروح وأنت مش متأكد وين رايح وشو رح يصير، بس مستعد تعيش التجربة العفوية بمرونتها.
            </p>
            <p>
