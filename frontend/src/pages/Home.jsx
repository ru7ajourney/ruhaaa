      ...
      <section className="story-section">
        <div className="container story-inner">
          <div className="story-text">
            ...
            <p>
أدهم رجع من إيطاليا وهو مش نفس الشخص؛ 10 أيام كمتطوع بريف توسكانا فرجته إنو في سفر من نوع ثاني بالكل، مش بس سياحة. تجربة عفوية مبنية على البساطة ومبدأ البساطه , تروح ومش متأكد وين رايح وشو رح يصير، بس مستعد تعيش المرونة.                      </p>
                      <p>
                          ومع إنه الحياة مشت وبدا يتناسى الموضوع، رن التلفون.. ذياب على الخط بيسأل عن الرحلة وحابب يجرب شيئ مشابه... ومن هذيك المحادثة العفوية ... وُلدت رُحى.
            </p>
